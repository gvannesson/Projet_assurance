...
if submitted:
    if st.session_state.smoker_radio==None or st.session_state.sex_radio==None or st.session_state.region==None:
        ...
        # bmi_df['BMI_cat'] = pd.cut(x=bmi_df['bmi'], bins = [0,18,25,30,35,40,50,60], labels=['sous poids','poids normal','surpoids','obésité modérée','obésité sévère','obésité morbide','obésité massive'])
